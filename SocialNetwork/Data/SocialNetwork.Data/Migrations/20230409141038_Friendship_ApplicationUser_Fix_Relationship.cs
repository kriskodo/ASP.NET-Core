...
{
    /// <inheritdoc />
    public partial class Friendship_ApplicationUser_Fix_Relationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccepterId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserPostId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostComments_Posts_ApplicationUserPostId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostLikes_Posts_ApplicationUserPostId",
                        column: x => x.ApplicationUserPostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_ApplicationUserPostId",
                table: "PostComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLikes_ApplicationUserPostId",
                table: "PostLikes",
                column: "ApplicationUserPostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostLikes_IsDeleted",
                table: "PostLikes",
                column: "IsDeleted");
